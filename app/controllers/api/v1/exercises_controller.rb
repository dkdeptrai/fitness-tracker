  ...
  module V1
    class ExercisesController < BaseController
      ...
      def index
        ...
        render json: @exercises, include: [:muscle_groups, :exercise_category], except: [:exercise_category_id]
      end

      def show
        render json: @exercise, include: [:muscle_groups, :exercise_category], except: [:exercise_category_id]
      end
